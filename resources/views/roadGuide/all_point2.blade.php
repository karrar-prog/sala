                            ...
                            <td>
                                ...
                                <form method="get" action="/family_search">
                                    ...
                                    <div style="width: 250px" class="col-sm-3">
                                        <input style="width: 250px" type="number" class="form-control" id="input_name"
                                               name="t_day"
                    ...
                    @foreach($allPoints as $point)
                        ...
                        @if(isset($_COOKIE["USER_SESSION"]))
                            ...
                            @if(isset($_COOKIE["USER_SESSION"]))
                                ...
                                <td style="width: 60px; background: white">{{$point->id}}</td>
                                <td style="width: 160px; background: white">
                                ...
                                <td style="width: 90px ; background: white">
                                ...
                                @else
                                    ...
                                    <td style="width: 120px; background: white">{{$point->date}}</td>
