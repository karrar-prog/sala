            ...
            @php $i=1; @endphp
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td style="width: 20px ;text-align: right">وصول,خارطة</td>
                        <td style="width: 20px ;text-align: right">تسلسل</td>
                        <td  style="width: 50px;text-align: right">الاسم</td>
                        <td style="width: 50px">رقم الهاتف</td>
                        <td style="width: 50px">اسم المختار</td>
                        <td style="width: 50px">الحي</td>
                        <td style="width: 50px">العنوان</td>
                        <td style="width: 50px">بطاقة التموينية</td>
                        <td style="width: 50px">تأريخ التسليم</td>
                    </tr>
                    ...
                    @if(isset($_COOKIE["USER_SESSION"]))
                        ...
                        @if(isset($_COOKIE["USER_SESSION"]))
                                    ...
                                    <td style="width: 130px"> <row>
                                            ...
                                            @if($point->date == null)
                                                <a style="width: 110px ; margin-top: 5px" href="/validate/{{$point->id}}" class="btn btn-dark">
                                    ...
                                    <td style="width: 90px">{{$point->admin_name}}</td>
