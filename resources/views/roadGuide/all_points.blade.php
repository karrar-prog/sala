...
@section("content")
    <div class="container py-4 ">
        <div class="row1 " id="all-points1">
            ...
            <div class="mb-4" style="margin-top: 60px;max-width: 170px">

                <form class="col-12 col-sm-6 " method="post" action="/nearby">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <button style="width: 170px" type="submit" class="btn btn-shadow"> الاقرب لموقعي الحالي
                            </button>
                ...
                <div class="row">
                    <form class="col-12 col-sm-6 " method="post" action="/family_search">
                        ...
                        <div style="margin-top: 10px ; margin-bottom: 10px" class="col-sm-3">
                            ...
                            <button type="submit" class="btn btn-shadow "> عوائل لم تصل لها مساعدة منذ<svg class="bi bi-search" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
