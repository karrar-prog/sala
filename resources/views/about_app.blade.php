...
@section('content')
    ...
    @if(isset($_COOKIE["USER_SESSION"]))
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <a href="/register" style="width: 230px;" class="btn btn-shadow">
                    <svg class="bi bi-person-plus" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="my_id" class="alert alert-success animated shake infinite" role="alert">
            مشروع سلة الخير هو مشروع خيري وغير ربحي ، يهدف لمساعدة العوائل المتضررة و المتعففة عن طريق تثبيت اماكن معيشتهم ليتسنى للفرق المساعدة وميسوري الحال للتواصل معهم وتقديم يد العون لهم
            <a href="/register">
               انضم الينا الان
            </a>
        </div>
