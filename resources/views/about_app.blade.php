            ...
            <h5 class="card-title">{{$phone}}
                <div class="card-body">
                    ...
                    <a href="/register" style="width: 230px;" class="btn btn-shadow">
                        <svg class="bi bi-person-plus" width="1.5em" height="1.5em" viewBox="0 0 16 16"
                ...
                <div class="card-body">
                    ...
                    <a style="width: 230px;" href="/new_family" class="btn btn-shadow">
                        <svg class="bi bi-geo-alt" width="1.5em" height="1.5em" viewBox="0 0 16 16" fill="currentColor"
                             xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
