        ...
        @if(session('message'))
            <div class="row">
                <div style="margin-top:70px" class="form-group alert alert-success animated shake  ">
                    ...
                    @else
                        <div id="hidden_div2"  style="display: none" class="row">
                        <div id="hidden_div2" class="col-12 d-flex justify-content-center">
                            <form class="col-12 col-sm-6" method="post" action="/123456789123456789/renew">
                                @csrf
                                ...
                                @else
                                    <div class="form-group alert alert-success ">
                                        ...
                                        <input oninput="setCustomValidity('')"
                                               oninvalid="this.setCustomValidity('يجب ادخال رقم البطاقة')"
                                               class="form-control"
                                               type="number" id="input_f1" required name="f1"
                                               placeholder="ادخل رقم بطاقة التموينية">
                                ...
                                <button name="location" id="btn_location" type="submit"
                                        class="btn btn-primary w-100 mt-5"><i class="fa fa-save fa-2x"> </i> تجديد الطلب
                                </button>
                                <div id="message2" class="alert alert-success " role="alert">
                                    في حالة الضغط على زر ( تجديد الطلب) انت تتعهد امام الله بصحة المعلومات المدخلة
                                </div>
                        ...
                        <div id="hidden_div" class="row">
                            <div style="margin-top:70px" class="form-group alert alert-success animated shake  ">
                                ...
                                ملاحظة مهمة: السلات الغذائية تعطى لمن يحتاجها من غير الميسورين والموظفين، وهي غير جائزة
                                شرعاً لغير
                                المستحقين
                            ...
                            <div id="hidden_div" class="col-12 d-flex justify-content-center">
                                <form class="col-12 col-sm-6" method="post" action="/123456789123456789/insert_point">
                                    ...
                                    <div class="form-group alert alert-success">
                                        ...
                                        <input oninput="setCustomValidity('')"
                                               oninvalid="this.setCustomValidity('يجب ادخال رقم الهاتف')" required
                                               class="form-control"
                                            ...
                                            <div class="alert alert-danger w-200 animated shake" role="alert">
                                                ...
                                                <div class="form-group  ">
                                                    @if(isset($_COOKIE["USER_SESSION"]))
                                                        <a href="/single/{{session('id')}}">مشاهدة تفاصيل هذه
                                                            العائلة</a>
                                                    @endif
                                    ...
                                    @else
                                        <div class="form-group alert alert-success ">
                                            ...
                                            <input style="margin-top: 20px" class="form-control" id="input_admin_name"
                                                   name="admin_name"
                                    ...
                                    <div class="row">
                                        <div id="message1" class="alert alert-primary" role="alert">
                                            اذا واجهت مشكلة في تحديد موقعك -افتح رابط سلة الخير في متصفح كروم (chrome)
                                            أو سفاري
                                            (safari)

                                            <a id="btn_get_location" class="btn btn-outline-info w-100"
                                               onclick="getLocation()"><i
                                                        class="fa fa-street-view fa-2x"> </i>اضغط هنا لتحديد موقعك
                                                الجغرافي </a>
                                        </div>

                                        <button name="location" id="btn_location" type="submit"
                                                class="btn btn-primary w-100 mt-5"><i class="fa fa-save fa-2x"> </i>
                                            ارسال الطلب
                                        </button>
                                        <div id="message2" class="alert alert-success " role="alert">
                                            في حالة الضغط على زر (ارسال الطلب) انت تتعهد امام الله بصحة المعلومات
                                            المدخلة
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input style="visibility: hidden;width: 20px" type="text"
                                                   class="form-control"
