...
@section("content")
                ...
                <div class="card text-center">
                    <div class="card-header">
                        <div id="message1" class="alert alert-primary" role="alert">
                            اذا كنت احد الحملات التطوعية - تواصل مع الكادر الان
                        </div>
                    </div>
                    <div class="card-header">
    ...
    <div class="container" style="margin-top: 60px;">
        ...
        {{--</div>--}}
        {{--<a href="/admin_register" class="btn btn-success"><i class="fa fa-chevron-right  "> انشاء حساب--}}
        {{--الان </i></a>--}}
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center">
                    <div class="card text-center">
                        ...
                        <div class="card-header">
                            لازال بأمكانك الوصول الى المستحقين من خلال <a href="/map">الخارطة</a> ويمكنك <a href="/new_family">اضافة</a> عائلتك او
                            عائلة جارك المتعففه
                        </div>
